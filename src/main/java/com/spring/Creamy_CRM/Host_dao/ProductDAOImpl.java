...
public class ProductDAOImpl implements ProductDAO {
	...
	/*
	@Override
	public int productGroupCnt(Map<String, Object> map2) {
		return sqlSession.selectOne("com.spring.Creamy_CRM.Host_dao.productDAO.productGroupCnt",map2);
	}
	*/
	//상품 개수
	@Override
	...
	public int chkProductGroupName(String product_group_name) {
		return sqlSession.selectOne("com.spring.Creamy_CRM.Host_dao.productDAO.chkProductGroupName", product_group_name);
	}

...
<script type="text/javascript">
	function addStock() {
		var url = "addStock";
		window.open(url, "재고추가","width=600, height=700, toolbar=no, menubar=no, scrollbars=no, resizable=yes");
	}
</script>
</head>
<body>
				...
				<div class="row">
					<div class="col-lg-9 animated fadeInRight">
						<div id="p_group">
							...
							<div>
								<button type="button" class="btn btn-primary dim">재고수정</button>
							</div>
							<div>
								<button type="button" class="btn btn-primary dim">재고삭제</button>
							</div>
						</div>

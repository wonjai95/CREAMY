...
<!-- ------------------------------- 예약등록표 시작 -->
	<div class="col-sm-4">
	    <div class="ibox ">
	        ...
	        <div class="ibox-content">
	            <form method="get">
	                <div class="form-group  row"><label class="col-sm-2 col-form-label">판매 형태</label>
	
	                    <div class="col-sm-10">
	                    
	                    
	                    <button type="button" class="btn btn-outline btn-primary">판매합니다?</button>
	                    <button type="button" class="btn btn-outline btn-primary">판매할까요?</button>
	                    <button type="button" class="btn btn-outline btn-primary">판매하니?</button>
	                    
	                    </div>
	                </div>
	                <div class="hr-line-dashed"></div>
	                <div class="form-group row"><label class="col-lg-2 col-form-label">판매 일자</label>
	
	                    <div class="col-lg-10"><input type="text" readonly value="2021-09-17" class="form-control"></div>
	                </div>
	                <div class="hr-line-dashed"></div>
	                
	                <div class="form-group row"><label class="col-sm-2 col-form-label">판매 시간</label>
	                ...
	                <div class="form-group row"><label class="col-lg-2 col-form-label">인원</label>
	                    ...
	                    <div class="col-lg-10"><input type="text" readonly value="2명" class="form-control"></div>
	                </div>
	                <div class="hr-line-dashed"></div>
	                
	                <div class="form-group row"><label class="col-lg-2 col-form-label">담당자</label>
	
	                    <div class="col-lg-10"><input type="text" readonly value="A38961 요정님" class="form-control"></div>
	                </div>
	                <div class="hr-line-dashed"></div>
	                
	                <div class="form-group row"><label class="col-lg-2 col-form-label">별도 요청</label>
	
	                    <div class="col-lg-10"><input type="text" readonly value="머리 잘 감겨주세요" class="form-control"></div>
	                </div>
	                <div class="hr-line-dashed"></div>
	                
	                <div class="form-group row"><label class="col-lg-2 col-form-label">예약 상품</label>
	
	                    <div class="col-lg-10"><input type="text" readonly value="머리 감겨주기" class="form-control"></div>
	                </div>
	                <div class="hr-line-dashed"></div>
	                
	                <div class="form-group row"><label class="col-lg-2 col-form-label">기타 메모</label>
	
	                    <div class="col-lg-10"><input type="text" readonly value="하..정말 힘들다" class="form-control"></div>
	                </div>
	                <div class="hr-line-dashed"></div>   
	            </form>
	        </div>
	        ...
	        <div class="ibox-content">
	            <form method="get">
	                ...
	                <div class="form-group row"><label class="col-sm-2 col-form-label">예약 시간</label>
	                    ...
	                    <select class="col-lg-8" name="account">
